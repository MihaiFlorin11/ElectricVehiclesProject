...
{
    public class CreateVehicleCommandHandler : IRequestHandler<CreateVehicleCommand, ViewVehicleDto>
    {
        private readonly IVehicleRepository _vehicleRepository;
        private readonly IVehicleTypeRepository _vehicleTypeRepository;
        private readonly IMapper _mapper;

        public CreateVehicleCommandHandler(IVehicleRepository vehicleRepository, IVehicleTypeRepository vehicleTypeRepository, IMapper mapper)
        {
        ...
        public async Task<ViewVehicleDto> Handle(CreateVehicleCommand request, CancellationToken cancellationToken)
        {
            ...
            var vehicle = await _vehicleRepository.AddVehicle(vehicleUnmapped);
